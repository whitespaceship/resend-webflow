...
const EMAIL_THEME = process.env.EMAIL_THEME || 'light';
...
app.post('/webhook', async (req, res) => {
  ...
  try {
    ...
    const htmlContent = EMAIL_THEME === 'dark' ? darkTemplate(email) : lightTemplate(email);
